...
for(let i = 0; i < toolBoxColors.length; i++) {
  ...
  toolBoxColors[i].addEventListener("click", (e) => {
    ...
    let filteredTickets = ticketsArr.filter((ticketObj, idx) => currentToolBoxColor === ticketObj.ticketColor);
    ...
    // displaying new filtered tickets
...
allPriorityColors.forEach((colorElem, idx) => {
  colorElem.addEventListener("click", (e) => {
    allPriorityColors.forEach((priorityColorElm, idx) => {
      priorityColorElm.classList.remove("border");
    })
...
function handleLock(ticket, id) {
  ...
  ticketLock.addEventListener("click", (e) => {
    ...
    // Modify data in localStorage (Ticket Task change)
...
function handleColor(ticket, id) {
  ...
  ticketColor.addEventListener("click", (e) => {
    ...
    let currentTicketColorIdx = colors.findIndex((color) => currentTicketColor === color);
